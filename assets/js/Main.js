...
export default class Main extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            fipopperleLinkData: null
        }

        this.getFileNameOfManifest = this.getFileNameOfManifest.bind(this);
    }


    getFileNameOfManifest(fileName) {

        const linkData = this.state.fileLinkData;
    ...
    componentDidMount() {
        ...
        const fatchLink = this.props.fatchLink
    ...
    render() {
        ...
        const buildImgUndraw_posting_photoSvg = this.getFileNameOfManifest("build/img/undraw_posting_photo.svg")

        console.log("buildImgUndraw_posting_photoSvg==", buildImgUndraw_posting_photoSvg);
                                    ...
                                    <div className="card shadow mb-4">
                                        ...
                                        <div className="card-body">
                                            <div className="text-center">
                                                {/*<img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: "25rem"}} src="{{ asset('build/img/undraw_posting_photo.svg') }}" alt=""/>*/}
                                                <img className="img-fluid px-3 px-sm-4 mt-3 mb-4"
                                                     style={{width: "25rem"}} src={buildImgUndraw_posting_photoSvg}
                                                     alt=""/>
                                            </div>
                                    ...
                                    <div className="card shadow mb-4">
                                        ...
                                        <div className="card-body">
                                            <p>SB Admin 2 makes extensive use of Bootstrap 4 utility classes in order to
                                                reduce CSS bloat and poor page performance. Custom CSS classes are used
                                                to create custom components and custom utility classes.</p>
