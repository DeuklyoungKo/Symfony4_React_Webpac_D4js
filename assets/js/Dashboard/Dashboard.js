...
import { getFileNameOfData, getDataOfManifest } from '../common/Api';
...
export default class Dashboard extends Component {
    ...
    render() {
        ...
        const { fileLinkData } = this.state;
        const buildImgUndraw_posting_photoSvg = getFileNameOfData(fileLinkData,"build/img/undraw_posting_photo.svg");
